...
/**
 * Renderer for the gradebook planstate report
 *
 ...
 * $renderer = $PAGE->get_renderer('gradereport_planstate');
 *
 * @copyright 2021 David Herney - cirano
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gradereport_planstate_renderer extends plugin_renderer_base {
