...
/**
 * Defines site settings for the planstate gradebook report
 *
...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configcheckbox('grade_report_planstate_showrank', get_string('showrank', 'grades'),
                   get_string('showrank_help', 'grades'), 0));

    $settings->add(new admin_setting_configselect('grade_report_planstate_showtotalsifcontainhidden', get_string('hidetotalifhiddenitems', 'grades'),
