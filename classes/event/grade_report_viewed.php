...
/**
 * Plan state report viewed event.
 *
...
namespace gradereport_planstate\event;

defined('MOODLE_INTERNAL') || die();

/**
 * Plan state report viewed event class.
 *
 * @package    gradereport_planstate
 * @since      Moodle 2.8
 * @copyright  2021 David Herney - cirano
...
class grade_report_viewed extends \core\event\grade_report_viewed {
    ...
    public static function get_name() {
        return get_string('eventgradereportviewed', 'gradereport_planstate');
    }
