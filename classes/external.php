...
/**
 * External grade report planstate API
 *
...
/**
 * External grade planstate report API implementation
 *
 * @package    gradereport_planstate
 * @copyright  2021 David Herney - cirano
 * @category   external
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gradereport_planstate_external extends external_api {
    ...
    public static function get_course_grades($userid = 0) {
        ...
        $gpr = new grade_plugin_return(array('type' => 'report', 'plugin' => 'planstate', 'courseid' => $course->id,
                                        'userid' => $userid));
        $report = new grade_report_planstate($userid, $gpr, $context);
    ...
    public static function view_grade_report($courseid, $userid = 0) {
        ...
        grade_report_planstate::viewed($context, $course->id, $userid);
