...
/**
 * Plan state grade report functions unit tests
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gradereport_planstate_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function setUp() {
        ...
        grade_get_setting($this->course1->id, 'report_planstate_showrank', 1);
    }
    ...
    public function test_get_course_grades_student() {
        ...
        $studentgrades = gradereport_planstate_external::get_course_grades();
        $studentgrades = external_api::clean_returnvalue(gradereport_planstate_external::get_course_grades_returns(), $studentgrades);
    ...
    public function test_get_course_grades_admin() {
        ...
        $studentgrades = gradereport_planstate_external::get_course_grades($this->student1->id);
        $studentgrades = external_api::clean_returnvalue(gradereport_planstate_external::get_course_grades_returns(), $studentgrades);
        $this->assertCount(0, $studentgrades['warnings']);
        $this->assertCount(2, $studentgrades['grades']);
        foreach ($studentgrades['grades'] as $grade) {
        ...
        $studentgrades = gradereport_planstate_external::get_course_grades($this->student2->id);
        $studentgrades = external_api::clean_returnvalue(gradereport_planstate_external::get_course_grades_returns(), $studentgrades);
        $this->assertCount(0, $studentgrades['warnings']);
        $this->assertCount(2, $studentgrades['grades']);
    ...
    public function test_get_course_grades_permissions() {
        ...
        $studentgrade = gradereport_planstate_external::get_course_grades($this->student1->id);
    }
    ...
    public function test_view_grade_report() {
        ...
        $this->setUser($this->student1);
        $result = gradereport_planstate_external::view_grade_report($this->course1->id);
        $result = external_api::clean_returnvalue(gradereport_planstate_external::view_grade_report_returns(), $result);
        $events = $sink->get_events();
        $this->assertCount(1, $events);
        $event = reset($events);

        // Check the event details are correct.
        $this->assertInstanceOf('\gradereport_planstate\event\grade_report_viewed', $event);
        ...
        $this->setUser($this->teacher);
        $result = gradereport_planstate_external::view_grade_report($this->course1->id, $this->student1->id);
        $result = external_api::clean_returnvalue(gradereport_planstate_external::view_grade_report_returns(), $result);
        $events = $sink->get_events();
        $event = reset($events);
        $sink->close();
    ...
    public function test_view_grade_report_permissions() {
        ...
        $studentgrade = gradereport_planstate_external::view_grade_report($this->course1->id, $this->student1->id);
    }
}
